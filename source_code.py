...
df = pd.read_csv(r'C:\Users\admin\Desktop\chatbot\tutorials\data-science\Linear Regression - House Price Predictions\data.csv')
...
predicted_price = model.predict(new_data)  # Predict the price
